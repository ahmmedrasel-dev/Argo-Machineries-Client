    ...
    <>
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content flex-col lg:flex-row">
          <img className='max-w-xl rounded-md animate__animated animate__zoomIn' src={product_img_1} alt="" />
          <div className='pr-12 max-w-xl'>
            ...
            <div className='mb-4'>
              ...
              <input type="text" placeholder="Quanity" class="input input-bordered input-md w-full max-w-xs" />
            </div>
